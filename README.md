...
pip install 'apache-airflow==2.6.0' \
 --constraint "https://raw.githubusercontent.com/apache/airflow/constraints-2.6.0/constraints-3.8.txt"
```
...
2. The "oldest" supported version of Python/Kubernetes is the default one until we decide to switch to
   ...
   and `apache/airflow:2.6.0` images are Python 3.8 images. This means that default reference image will
